...
function render(ElementPtr)
    ...
    Text("Press F11 to Save a Screenshot into the Client Folder")
    Text("Controls:")
    NewLine()
    if BeginTabBar("AboutTab") then
        if CreateTabWindow("SHMD") then
            ...
            Text("    + Shift -> Paste the Object with a Random Rotation")
            Text("    + Space -> Paste the Object with a Random Scale")
